...
class PersonalDetailButton: UIButton {
    ...
    func configureDataInput(detailName: String, detailValue: String, isArrowPresent: Bool, isSeparatorNeeded: Bool) {
        detailNameLabel.text = detailName
        detailValueLabel.text = detailValue
        if isArrowPresent {
            mainView.addArrangedSubview(arrowImage)
        }
